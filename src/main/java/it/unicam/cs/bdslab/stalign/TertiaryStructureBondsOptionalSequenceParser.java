...
public class TertiaryStructureBondsOptionalSequenceParser extends Parser {
    ...
    public static final int RULE_strucure = 0, RULE_sequence = 1,
	    RULE_bonds = 2, RULE_bond = 3;

    private static String[] makeRuleNames() {
	return new String[] { "strucure", "sequence", "bonds", "bond" };
    }
	...
	public AasFormatContext(StrucureContext ctx) {
	    copyFrom(ctx);
	}

	@Override
	public void enterRule(ParseTreeListener listener) {
	    if (listener instanceof TertiaryStructureBondsOptionalSequenceListener)
		((TertiaryStructureBondsOptionalSequenceListener) listener)
			.enterAasFormat(this);
	}
	...
	public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	    if (visitor instanceof TertiaryStructureBondsOptionalSequenceVisitor)
		return ((TertiaryStructureBondsOptionalSequenceVisitor<? extends T>) visitor)
			.visitAasFormat(this);
	    else
	...
	public TerminalNode LETTERS() {
	    return getToken(
		    TertiaryStructureBondsOptionalSequenceParser.LETTERS, 0);
	}
	...
	public List<TerminalNode> INDEX() {
	    return getTokens(
		    TertiaryStructureBondsOptionalSequenceParser.INDEX);
	}

	public TerminalNode INDEX(int i) {
	    return getToken(
		    TertiaryStructureBondsOptionalSequenceParser.INDEX, i);
	}
